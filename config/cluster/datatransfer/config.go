...
import (
	...
	"github.com/tagesjump/provider-upjet-yc/config/cluster/mdb"
	"github.com/tagesjump/provider-upjet-yc/config/cluster/vpc"
)

const (
	// ApisPackagePath is the golang path for this package.
	ApisPackagePath = "github.com/tagesjump/provider-upjet-yc/apis/cluster/datatransfer/v1alpha1"
	// ConfigPath is the golang path for this package.
	ConfigPath = "github.com/tagesjump/provider-upjet-yc/config/cluster/datatransfer"
)
