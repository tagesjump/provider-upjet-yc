...
const (
	...
	ApisPackagePath = "github.com/tagesjump/provider-upjet-yc/apis/cluster/storage/v1alpha1"
	// ConfigPath is the golang path for this package.
	ConfigPath = "github.com/tagesjump/provider-upjet-yc/config/cluster/storage"
)
