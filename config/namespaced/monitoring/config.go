...
import (
	...
	"github.com/tagesjump/provider-upjet-yc/config/namespaced/resourcemanager"
)

const (
	// ApisPackagePath is the golang path for this package.
	ApisPackagePath = "github.com/tagesjump/provider-upjet-yc/apis/namespaced/monitoring/v1alpha1"
	// ConfigPath is the golang path for this package.
	ConfigPath = "github.com/tagesjump/provider-upjet-yc/config/namespaced/monitoring"
)
