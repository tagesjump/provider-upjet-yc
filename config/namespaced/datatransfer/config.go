...
import (
	...
	"github.com/tagesjump/provider-upjet-yc/config/namespaced/mdb"
	"github.com/tagesjump/provider-upjet-yc/config/namespaced/vpc"
)

const (
	// ApisPackagePath is the golang path for this package.
	ApisPackagePath = "github.com/tagesjump/provider-upjet-yc/apis/namespaced/datatransfer/v1alpha1"
	// ConfigPath is the golang path for this package.
	ConfigPath = "github.com/tagesjump/provider-upjet-yc/config/namespaced/datatransfer"
)
