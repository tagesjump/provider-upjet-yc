...
import (
	...
	"github.com/tagesjump/provider-upjet-yc/apis"
	"github.com/tagesjump/provider-upjet-yc/apis/v1alpha1"
	"github.com/tagesjump/provider-upjet-yc/config"
	"github.com/tagesjump/provider-upjet-yc/internal/clients"
	"github.com/tagesjump/provider-upjet-yc/internal/controller"
...
func main() {
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup YandexCloud controllers")
