...
import (
	...
	v1alpha1 "github.com/tagesjump/provider-upjet-yc/apis/namespaced/metastore/v1alpha1"
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewTerraformPluginFrameworkAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["yandex_metastore_cluster"],
