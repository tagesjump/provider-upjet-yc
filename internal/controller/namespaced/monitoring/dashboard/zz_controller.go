...
import (
	...
	v1alpha1 "github.com/tagesjump/provider-upjet-yc/apis/namespaced/monitoring/v1alpha1"
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewTerraformPluginSDKAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["yandex_monitoring_dashboard"],
				...
				tjcontroller.WithTerraformPluginSDKAsyncMetricRecorder(metrics.NewMetricRecorder(v1alpha1.Dashboard_GroupVersionKind, mgr, o.PollInterval)),
