module github.com/tagesjump/provider-upjet-yc
...
require (
	...
	github.com/yandex-cloud/terraform-provider-yandex v0.130.0
...
require (
	...
	github.com/ydb-platform/terraform-provider-ydb v0.0.21 // indirect
