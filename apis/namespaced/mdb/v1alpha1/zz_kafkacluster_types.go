...
type KafkaClusterConfigAccessInitParameters struct {
...
type KafkaClusterConfigAccessObservation struct {
...
type KafkaClusterConfigAccessParameters struct {
...
type KafkaClusterConfigInitParameters struct {
	...
	Access []KafkaClusterConfigAccessInitParameters `json:"access,omitempty" tf:"access,omitempty"`
	...
	Kafka []KafkaClusterConfigKafkaInitParameters `json:"kafka,omitempty" tf:"kafka,omitempty"`
...
type KafkaClusterConfigKafkaInitParameters struct {
...
type KafkaClusterConfigKafkaObservation struct {
...
type KafkaClusterConfigKafkaParameters struct {
...
type KafkaClusterConfigObservation struct {
	...
	// (Block List, Max: 1) Access policy to the Kafka cluster. (see below for nested schema)
	// Access policy to the Kafka cluster.
	Access []KafkaClusterConfigAccessObservation `json:"access,omitempty" tf:"access,omitempty"`
	...
	// (Block List, Min: 1, Max: 1) Configuration of the Kafka subcluster. (see below for nested schema)
	// Configuration of the Kafka subcluster.
	Kafka []KafkaClusterConfigKafkaObservation `json:"kafka,omitempty" tf:"kafka,omitempty"`
	...
	// (String) Patch version of the Kafka server software.
...
type KafkaClusterConfigParameters struct {
	...
	// Access policy to the Kafka cluster.
	// +kubebuilder:validation:Optional
	Access []KafkaClusterConfigAccessParameters `json:"access,omitempty" tf:"access,omitempty"`
	...
	// Configuration of the Kafka subcluster.
	// +kubebuilder:validation:Optional
	Kafka []KafkaClusterConfigKafkaParameters `json:"kafka" tf:"kafka,omitempty"`
...
type KafkaClusterInitParameters struct {
	...
	// (String) ID of the KMS key to encrypt cluster disks.
