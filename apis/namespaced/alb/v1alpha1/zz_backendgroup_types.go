...
type GRPCBackendInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	TargetGroupIdsRefs []v1.NamespacedReference `json:"targetGroupIdsRefs,omitempty" tf:"-"`
...
type HTTPBackendTLSInitParameters struct {
	...
	// (Block List, Max: 1) Validation context (see below for nested schema)
	// Validation context
...
type StreamBackendInitParameters struct {
	...
	// (Boolean) Enables TCP proxy protocol support for upstream backend
