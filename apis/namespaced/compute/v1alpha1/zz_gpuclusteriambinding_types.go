...
type GpuClusterIAMBindingInitParameters struct {
	...
	// (String) The ID of the compute gpu_cluster to attach the policy to.
	...
	// (String) The role that should be assigned. Only one yandex_compute_gpu_cluster_iam_binding can be used per role.
...
// GpuClusterIAMBinding is the Schema for the GpuClusterIAMBindings API. Allows management of a single IAM binding for the GPU Cluster.
