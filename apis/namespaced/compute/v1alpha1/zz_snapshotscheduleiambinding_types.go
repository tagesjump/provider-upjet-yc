...
type SnapshotScheduleIAMBindingInitParameters struct {
	...
	// (String) The role that should be assigned. Only one yandex_compute_snapshot_schedule_iam_binding can be used per role.
	...
	// (String) The ID of the compute snapshot_schedule to attach the policy to.
...
// SnapshotScheduleIAMBinding is the Schema for the SnapshotScheduleIAMBindings API. Allows management of a single IAM binding for the Snapshot Schedule.
