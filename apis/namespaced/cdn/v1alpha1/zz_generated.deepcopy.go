...
func (in *EdgeCacheSettingsCodesInitParameters) DeepCopyInto(out *EdgeCacheSettingsCodesInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EdgeCacheSettingsCodesInitParameters.
func (in *EdgeCacheSettingsCodesInitParameters) DeepCopy() *EdgeCacheSettingsCodesInitParameters {
	if in == nil {
		return nil
	}
	out := new(EdgeCacheSettingsCodesInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EdgeCacheSettingsCodesObservation) DeepCopyInto(out *EdgeCacheSettingsCodesObservation) {
	*out = *in
	if in.CustomValues != nil {
		in, out := &in.CustomValues, &out.CustomValues
		*out = make(map[string]*float64, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EdgeCacheSettingsCodesObservation.
func (in *EdgeCacheSettingsCodesObservation) DeepCopy() *EdgeCacheSettingsCodesObservation {
	if in == nil {
		return nil
	}
	out := new(EdgeCacheSettingsCodesObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EdgeCacheSettingsCodesParameters) DeepCopyInto(out *EdgeCacheSettingsCodesParameters) {
	*out = *in
	if in.CustomValues != nil {
		in, out := &in.CustomValues, &out.CustomValues
		*out = make(map[string]*float64, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EdgeCacheSettingsCodesParameters.
func (in *EdgeCacheSettingsCodesParameters) DeepCopy() *EdgeCacheSettingsCodesParameters {
	if in == nil {
		return nil
	}
	out := new(EdgeCacheSettingsCodesParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OptionsInitParameters) DeepCopyInto(out *OptionsInitParameters) {
	*out = *in
	...
	if in.EdgeCacheSettingsCodes != nil {
		in, out := &in.EdgeCacheSettingsCodes, &out.EdgeCacheSettingsCodes
		*out = make([]EdgeCacheSettingsCodesInitParameters, len(*in))
		for i := range *in {
	...
	if in.RewriteFlag != nil {
		in, out := &in.RewriteFlag, &out.RewriteFlag
		*out = new(string)
		**out = **in
	}
	if in.RewritePattern != nil {
		in, out := &in.RewritePattern, &out.RewritePattern
		*out = new(string)
		**out = **in
	}
	if in.SecureKey != nil {
...
func (in *OptionsObservation) DeepCopyInto(out *OptionsObservation) {
	*out = *in
	...
	if in.EdgeCacheSettingsCodes != nil {
		in, out := &in.EdgeCacheSettingsCodes, &out.EdgeCacheSettingsCodes
		*out = make([]EdgeCacheSettingsCodesObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *OptionsParameters) DeepCopyInto(out *OptionsParameters) {
	*out = *in
	...
	if in.EdgeCacheSettingsCodes != nil {
		in, out := &in.EdgeCacheSettingsCodes, &out.EdgeCacheSettingsCodes
		*out = make([]EdgeCacheSettingsCodesParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ResourceInitParameters) DeepCopyInto(out *ResourceInitParameters) {
	*out = *in
	...
	if in.Shielding != nil {
		in, out := &in.Shielding, &out.Shielding
		*out = new(string)
		**out = **in
	}
	if in.UpdatedAt != nil {
