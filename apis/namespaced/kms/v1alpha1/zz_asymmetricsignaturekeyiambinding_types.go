...
type AsymmetricSignatureKeyIAMBindingInitParameters struct {
	...
	AsymmetricSignatureKeyIDRef *v1.NamespacedReference `json:"asymmetricSignatureKeyIdRef,omitempty" tf:"-"`

	// Selector for a AsymmetricSignatureKey to populate asymmetricSignatureKeyId.
	// +kubebuilder:validation:Optional
	AsymmetricSignatureKeyIDSelector *v1.NamespacedSelector `json:"asymmetricSignatureKeyIdSelector,omitempty" tf:"-"`
