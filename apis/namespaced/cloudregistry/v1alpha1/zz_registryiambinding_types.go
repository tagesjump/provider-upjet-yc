...
type RegistryIAMBindingInitParameters struct {
	...
	// (String) The ID of the compute registry to attach the policy to.
	...
	// (String) The role that should be assigned. Only one yandex_cloudregistry_registry_iam_binding can be used per role.
...
// RegistryIAMBinding is the Schema for the RegistryIAMBindings API. Allows management of a single IAM binding for a Yandex Cloud Registry.
