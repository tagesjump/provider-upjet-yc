...
type ProviderConfigSpec struct {
	...
	// Useful for Yandex Cloud-like implementations that use their own region names or to bypass the validation for
...
// A ProviderConfig configures a YandexCloud provider.
...
// A ClusterProviderConfig configures a YandexCloud provider.
// +kubebuilder:subresource:status
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:printcolumn:name="SOURCE",type="string",JSONPath=".spec.source",priority=1
