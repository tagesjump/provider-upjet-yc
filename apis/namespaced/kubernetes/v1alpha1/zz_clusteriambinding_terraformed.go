...
func (mg *ClusterIAMBinding) GetTerraformResourceType() string {
	return "yandex_kubernetes_cluster_iam_binding"
}
...
func (tr *ClusterIAMBinding) GetObservation() (map[string]any, error) {
...
func (tr *ClusterIAMBinding) SetObservation(obs map[string]any) error {
...
func (tr *ClusterIAMBinding) GetParameters() (map[string]any, error) {
...
func (tr *ClusterIAMBinding) SetParameters(params map[string]any) error {
...
// GetInitParameters of this ClusterIAMBinding
func (tr *ClusterIAMBinding) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ClusterIAMBinding
func (tr *ClusterIAMBinding) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
