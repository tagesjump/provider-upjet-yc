...
func (mg *ClusterIAMMember) GetTerraformResourceType() string {
	return "yandex_kubernetes_cluster_iam_member"
}
...
func (tr *ClusterIAMMember) GetObservation() (map[string]any, error) {
...
func (tr *ClusterIAMMember) SetObservation(obs map[string]any) error {
...
func (tr *ClusterIAMMember) GetParameters() (map[string]any, error) {
...
func (tr *ClusterIAMMember) SetParameters(params map[string]any) error {
...
// GetInitParameters of this ClusterIAMMember
func (tr *ClusterIAMMember) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ClusterIAMMember
func (tr *ClusterIAMMember) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
