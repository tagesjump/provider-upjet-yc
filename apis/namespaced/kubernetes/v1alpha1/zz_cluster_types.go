...
type ClusterInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	NodeServiceAccountIDRef *v1.NamespacedReference `json:"nodeServiceAccountIdRef,omitempty" tf:"-"`

	// Selector for a SecurityGroup in vpc to populate nodeServiceAccountId.
	// +kubebuilder:validation:Optional
	NodeServiceAccountIDSelector *v1.NamespacedSelector `json:"nodeServiceAccountIdSelector,omitempty" tf:"-"`
	...
	// (Block List, Max: 1) Workload Identity Federation configuration. (see below for nested schema)
...
type MasterLoggingInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/tagesjump/provider-upjet-yc/apis/namespaced/logging/v1alpha1.Group
