...
type SecurityRuleInitParameters struct {
	...
	// (Number) Priority of the rule. Lower value means higher priority.
...
// Captcha is the Schema for the Captchas API. Allows management of a Yandex Cloud SmartCaptcha.
