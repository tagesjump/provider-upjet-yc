...
type DatabaseIAMBindingInitParameters struct {
	...
	// (String) The ID of the compute database to attach the policy to.
	// The ID of the compute `database` to attach the policy to.
	...
	// (String) The role that should be assigned. Only one yandex_ydb_database_iam_binding can be used per role.
	// The role that should be assigned. Only one yandex_ydb_database_iam_binding can be used per role.
...
// DatabaseIAMBinding is the Schema for the DatabaseIAMBindings API. Allows management of a single IAM binding for a Managed service for YDB.
