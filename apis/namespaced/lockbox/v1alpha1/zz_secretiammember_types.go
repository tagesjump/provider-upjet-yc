...
type SecretIAMMemberInitParameters struct {
	...
	// (String) The role that should be assigned. Only one yandex_lockbox_secret_iam_member can be used per role.
...
// SecretIAMMember is the Schema for the SecretIAMMembers API. Allows management of a single member for a single IAM binding for a Lockbox Secret.
