...
type SecurityGroupRuleInitParameters struct {
	...
	SecurityGroupBindingRef *v1.NamespacedReference `json:"securityGroupBindingRef,omitempty" tf:"-"`

	// Selector for a SecurityGroup to populate securityGroupBinding.
	// +kubebuilder:validation:Optional
	SecurityGroupBindingSelector *v1.NamespacedSelector `json:"securityGroupBindingSelector,omitempty" tf:"-"`
