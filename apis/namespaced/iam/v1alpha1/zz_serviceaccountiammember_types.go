...
type ServiceAccountIAMMemberInitParameters struct {
	...
	// (String) The role that should be assigned. Only one yandex_iam_service_account_iam_member can be used per role.
	// The role that should be assigned. Only one yandex_iam_service_account_iam_member can be used per role.
	Role *string `json:"role,omitempty" tf:"role,omitempty"`

	// (String) The ID of the compute service_account to attach the policy to.
