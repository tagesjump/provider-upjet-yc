...
type ServiceAccountAPIKeyInitParameters struct {
	...
	OutputToLockbox []ServiceAccountAPIKeyOutputToLockboxInitParameters `json:"outputToLockbox,omitempty" tf:"output_to_lockbox,omitempty"`
	...
	// (String, Deprecated) The scope of the key. Use lifecycle {ignore_changes = [scope]} directive to avoid false changes on apply.
...
type ServiceAccountAPIKeyObservation struct {
	...
	// (Block List, Max: 1) option to create a Lockbox secret version from sensitive outputs (see below for nested schema)
	// option to create a Lockbox secret version from sensitive outputs
	OutputToLockbox []ServiceAccountAPIKeyOutputToLockboxObservation `json:"outputToLockbox,omitempty" tf:"output_to_lockbox,omitempty"`
...
type ServiceAccountAPIKeyOutputToLockboxInitParameters struct {
...
type ServiceAccountAPIKeyOutputToLockboxObservation struct {
...
type ServiceAccountAPIKeyOutputToLockboxParameters struct {
...
type ServiceAccountAPIKeyParameters struct {
	...
	// option to create a Lockbox secret version from sensitive outputs
	// +kubebuilder:validation:Optional
	OutputToLockbox []ServiceAccountAPIKeyOutputToLockboxParameters `json:"outputToLockbox,omitempty" tf:"output_to_lockbox,omitempty"`
