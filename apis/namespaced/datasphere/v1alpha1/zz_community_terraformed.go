...
func (mg *Community) GetTerraformResourceType() string {
	return "yandex_datasphere_community"
}
...
func (tr *Community) GetObservation() (map[string]any, error) {
...
func (tr *Community) SetObservation(obs map[string]any) error {
...
func (tr *Community) GetParameters() (map[string]any, error) {
...
func (tr *Community) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Community
func (tr *Community) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Community
func (tr *Community) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
