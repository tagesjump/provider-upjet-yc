...
func (mg *ImageIAMBinding) GetTerraformResourceType() string {
	return "yandex_compute_image_iam_binding"
}
...
func (tr *ImageIAMBinding) GetObservation() (map[string]any, error) {
...
func (tr *ImageIAMBinding) SetObservation(obs map[string]any) error {
...
func (tr *ImageIAMBinding) GetParameters() (map[string]any, error) {
...
func (tr *ImageIAMBinding) SetParameters(params map[string]any) error {
...
// GetInitParameters of this ImageIAMBinding
func (tr *ImageIAMBinding) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ImageIAMBinding
func (tr *ImageIAMBinding) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
