...
func (mg *AccessControl) GetTerraformResourceType() string {
	return "yandex_trino_access_control"
}
...
// GetInitParameters of this AccessControl
func (tr *AccessControl) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AccessControl
func (tr *AccessControl) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
