...
func (in *DNSOptionsInitParameters) DeepCopyInto(out *DNSOptionsInitParameters) {
	*out = *in
	if in.PrivateDNSRecordsEnabled != nil {
		in, out := &in.PrivateDNSRecordsEnabled, &out.PrivateDNSRecordsEnabled
		*out = new(bool)
		**out = **in
	}
}
...
func (in *GatewayInitParameters) DeepCopyInto(out *GatewayInitParameters) {
	*out = *in
	...
	if in.SharedEgressGateway != nil {
		in, out := &in.SharedEgressGateway, &out.SharedEgressGateway
		*out = make([]SharedEgressGatewayInitParameters, len(*in))
		copy(*out, *in)
	}
}
...
func (in *GatewayObservation) DeepCopyInto(out *GatewayObservation) {
	*out = *in
	...
	if in.SharedEgressGateway != nil {
		in, out := &in.SharedEgressGateway, &out.SharedEgressGateway
		*out = make([]SharedEgressGatewayParameters, len(*in))
		copy(*out, *in)
	}
}
...
func (in *PrivateEndpointInitParameters) DeepCopyInto(out *PrivateEndpointInitParameters) {
	*out = *in
	...
	if in.EndpointAddress != nil {
		...
		*out = make([]EndpointAddressInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PrivateEndpointObservation) DeepCopyInto(out *PrivateEndpointObservation) {
	*out = *in
	...
	if in.EndpointAddress != nil {
		in, out := &in.EndpointAddress, &out.EndpointAddress
		*out = make([]EndpointAddressObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PrivateEndpointParameters) DeepCopyInto(out *PrivateEndpointParameters) {
	*out = *in
	...
	if in.EndpointAddress != nil {
		in, out := &in.EndpointAddress, &out.EndpointAddress
		*out = make([]EndpointAddressParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SharedEgressGatewayInitParameters) DeepCopyInto(out *SharedEgressGatewayInitParameters) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SharedEgressGatewayInitParameters.
func (in *SharedEgressGatewayInitParameters) DeepCopy() *SharedEgressGatewayInitParameters {
	if in == nil {
		return nil
	}
	out := new(SharedEgressGatewayInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SharedEgressGatewayObservation) DeepCopyInto(out *SharedEgressGatewayObservation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SharedEgressGatewayObservation.
func (in *SharedEgressGatewayObservation) DeepCopy() *SharedEgressGatewayObservation {
	if in == nil {
		return nil
	}
	out := new(SharedEgressGatewayObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SharedEgressGatewayParameters) DeepCopyInto(out *SharedEgressGatewayParameters) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SharedEgressGatewayParameters.
func (in *SharedEgressGatewayParameters) DeepCopy() *SharedEgressGatewayParameters {
	if in == nil {
		return nil
	}
	out := new(SharedEgressGatewayParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SubnetInitParameters) DeepCopyInto(out *SubnetInitParameters) {
	*out = *in
	if in.DHCPOptions != nil {
		...
		*out = make([]DHCPOptionsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
