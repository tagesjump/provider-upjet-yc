...
func (mg *Connection) GetTerraformResourceType() string {
	return "yandex_connectionmanager_connection"
}

// GetConnectionDetailsMapping for this Connection
func (tr *Connection) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"params.clickhouse.auth.user_password.password.raw": "params.clickhouse.auth.userPassword.password.rawSecretRef", "params.greenplum.auth.user_password.password.raw": "params.greenplum.auth.userPassword.password.rawSecretRef", "params.kafka.auth.sasl.password.raw": "params.kafka.auth.sasl.password.rawSecretRef", "params.mongodb.auth.user_password.password.raw": "params.mongodb.auth.userPassword.password.rawSecretRef", "params.mysql.auth.user_password.password.raw": "params.mysql.auth.userPassword.password.rawSecretRef", "params.opensearch.auth.user_password.password.raw": "params.opensearch.auth.userPassword.password.rawSecretRef", "params.postgresql.auth.user_password.password.raw": "params.postgresql.auth.userPassword.password.rawSecretRef", "params.redis.auth.user_password.password.raw": "params.redis.auth.userPassword.password.rawSecretRef", "params.storedoc.auth.user_password.password.raw": "params.storedoc.auth.userPassword.password.rawSecretRef", "params.trino.auth.user_password.password.raw": "params.trino.auth.userPassword.password.rawSecretRef", "params.valkey.auth.user_password.password.raw": "params.valkey.auth.userPassword.password.rawSecretRef"}
}
