...
type InstanceIAMBindingInitParameters struct {
	...
	// (String) The ID of the compute instance to attach the policy to.
	...
	// (String) The role that should be assigned. Only one yandex_compute_instance_iam_binding can be used per role.
...
// InstanceIAMBinding is the Schema for the InstanceIAMBindings API. Allows management of a single IAM binding for the Compute Instance.
