...
type DiskPlacementGroupIAMBindingInitParameters struct {
	...
	// (String) The ID of the compute disk_placement_group to attach the policy to.
	// The ID of the compute `disk_placement_group` to attach the policy to.
	...
	// (String) The role that should be assigned. Only one yandex_compute_disk_placement_group_iam_binding can be used per role.
...
// DiskPlacementGroupIAMBinding is the Schema for the DiskPlacementGroupIAMBindings API. Allows management of a single IAM binding for the Disk Placement Group.
