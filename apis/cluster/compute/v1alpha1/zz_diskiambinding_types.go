...
type DiskIAMBindingInitParameters struct {
	...
	// (String) The ID of the compute disk to attach the policy to.
...
// DiskIAMBinding is the Schema for the DiskIAMBindings API. Allows management of a single IAM binding for the compute Disk.
