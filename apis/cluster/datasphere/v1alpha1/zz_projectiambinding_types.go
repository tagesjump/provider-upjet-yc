...
type ProjectIAMBindingInitParameters struct {
	...
	// (String) The ID of the compute project to attach the policy to.
	// The ID of the compute `project` to attach the policy to.
	ProjectID *string `json:"projectId,omitempty" tf:"project_id,omitempty"`

	// (String) The role that should be assigned. Only one yandex_datasphere_project_iam_binding can be used per role.
...
// ProjectIAMBinding is the Schema for the ProjectIAMBindings API. Allows management of a single IAM binding for a Yandex Datasphere Project.
