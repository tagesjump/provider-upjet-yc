...
type SAMLFederationInitParameters struct {
	...
	SecuritySettings []SAMLFederationSecuritySettingsInitParameters `json:"securitySettings,omitempty" tf:"security_settings,omitempty"`
...
type SAMLFederationObservation struct {
	...
	// (Block List, Max: 1) Federation security settings. (see below for nested schema)
	// Federation security settings.
	SecuritySettings []SAMLFederationSecuritySettingsObservation `json:"securitySettings,omitempty" tf:"security_settings,omitempty"`
...
type SAMLFederationParameters struct {
	...
	// Federation security settings.
	// +kubebuilder:validation:Optional
	SecuritySettings []SAMLFederationSecuritySettingsParameters `json:"securitySettings,omitempty" tf:"security_settings,omitempty"`
...
type SAMLFederationSecuritySettingsInitParameters struct {
...
type SAMLFederationSecuritySettingsObservation struct {
...
type SAMLFederationSecuritySettingsParameters struct {
