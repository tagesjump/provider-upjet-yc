...
type BucketInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/tagesjump/provider-upjet-yc/apis/cluster/iam/v1alpha1.ServiceAccountStaticAccessKey
	// +crossplane:generate:reference:extractor=github.com/tagesjump/provider-upjet-yc/config/cluster/common.ExtractAccessKey()
	...
	// (Boolean) If true, static key authentication in bucket is forbidden. Default is false.
